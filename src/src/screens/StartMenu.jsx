  ...
  return (
    <div style={{
      ...
      <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.07 }}
        viewBox="0 0 380 800" preserveAspectRatio="xMidYMid slice">
      ...
      <div style={{
        ...
        background: "linear-gradient(180deg, rgba(10,22,40,0.55) 0%, rgba(10,22,40,0.25) 40%, rgba(10,22,40,0.9) 100%)",
      }}/>
      ...
      <div style={{
        ...
        padding: "56px 24px 24px", gap: 0,
      }}>
        {/* Logo */}
        <div style={{ textAlign: "center", marginBottom: 8 }}>
          <div style={{
            fontFamily: "'Barlow', sans-serif", fontSize: 11, fontWeight: 600,
            letterSpacing: 4, textTransform: "uppercase", color: "#1D9E75", marginBottom: 6,
          }}>
            {t.badge}
          </div>
          <h1 style={{
            fontFamily: "'Bebas Neue', cursive", fontSize: 64, letterSpacing: 3,
            color: "#e8f4ff", lineHeight: 1, margin: 0,
        ...
        {/* Divisor */}
        <div style={{
          width: 48, height: 2, background: "#1D9E75",
          margin: "20px auto 28px", borderRadius: 2,
        }}/>

        {/* Botones */}
        <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%", maxWidth: 320 }}>
          {buttons.map(btn => (
            <button key={btn.id} onClick={() => onStart(btn.id)} style={{
              width: "100%", padding: "16px 20px",
              borderRadius: 10, border: btn.primary ? "none" : "0.5px solid #1e3a5f",
              ...
              <div style={{
                ...
                background: btn.primary ? "rgba(255,255,255,0.15)" : "rgba(29,158,117,0.12)",
              }}>
                {btn.icon}
              </div>
              <div style={{ flex: 1 }}>
                {btn.label}
                <span style={{ fontSize: 11, fontWeight: 400, opacity: 0.65, display: "block", marginTop: 1 }}>
                  {btn.desc}
                </span>
              </div>
            </button>
      ...
      <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 320, padding: "0 24px 40px" }}>
        <select
          value={language}
          onChange={e => setLanguage(e.target.value)}
          style={{
            width: "100%", padding: "12px 16px",
            background: "#0d1f3c", border: "0.5px solid #1e3a5f",
        ...
        <div style={{ textAlign: "center", fontSize: 10, color: "#2a4a6b", marginTop: 10, letterSpacing: 1 }}>
          {t.version}
        </div>
      </div>
    </div>
